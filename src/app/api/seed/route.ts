...
export async function GET() {
  ...
  // ─── Products ─────────────────────────────────────────
  const productsList = [
    { sellerId: sellerDoc1Id, name: "Wireless Bluetooth Headphones", description: "Premium noise-cancelling wireless headphones with 30hr battery life.", price: 89.99, compareAtPrice: 129.99, stock: 45, category: "Electronics", tags: ["headphones", "bluetooth"], images: ["https://res.cloudinary.com/demo/image/upload/v1/samples/ecommerce/headphones.jpg"], isActive: true, isFeatured: true, rating: 4.6, reviewCount: 24 },
    { sellerId: sellerDoc1Id, name: "Smart Watch Pro X", description: "Feature-packed smartwatch with heart rate monitor, GPS tracking, and 7-day battery.", price: 199.99, compareAtPrice: 249.99, stock: 30, category: "Electronics", tags: ["smartwatch", "fitness"], images: ["https://res.cloudinary.com/demo/image/upload/v1/samples/ecommerce/watch.jpg"], isActive: true, isFeatured: true, rating: 4.3, reviewCount: 18 },
    { sellerId: sellerDoc1Id, name: "USB-C Fast Charging Cable (2m)", description: "Durable braided USB-C cable with 100W fast charging support.", price: 12.99, stock: 200, category: "Accessories", tags: ["cable", "usb-c"], images: ["https://res.cloudinary.com/demo/image/upload/v1/samples/ecommerce/cable.jpg"], isActive: true, isFeatured: false, rating: 4.1, reviewCount: 56 },
    { sellerId: sellerDoc1Id, name: "Portable Bluetooth Speaker", description: "Compact waterproof speaker with 360° sound and 12hr battery.", price: 49.99, compareAtPrice: 69.99, stock: 60, category: "Electronics", tags: ["speaker", "bluetooth"], images: ["https://res.cloudinary.com/demo/image/upload/v1/samples/ecommerce/speaker.jpg"], isActive: true, isFeatured: false, rating: 4.4, reviewCount: 31 },
    { sellerId: sellerDoc1Id, name: "Mechanical Gaming Keyboard", description: "RGB mechanical keyboard with Cherry MX switches and aluminum frame.", price: 74.99, stock: 25, category: "Electronics", tags: ["keyboard", "gaming"], images: ["https://res.cloudinary.com/demo/image/upload/v1/samples/ecommerce/keyboard.jpg"], isActive: true, isFeatured: true, rating: 4.7, reviewCount: 42 },
    { sellerId: sellerDoc2Id, name: "Floral Summer Dress", description: "Lightweight floral print dress. Breathable cotton with adjustable waist tie.", price: 39.99, compareAtPrice: 59.99, stock: 80, category: "Fashion", tags: ["dress", "summer"], images: ["https://res.cloudinary.com/demo/image/upload/v1/samples/ecommerce/dress.jpg"], isActive: true, isFeatured: true, rating: 4.8, reviewCount: 15 },
    { sellerId: sellerDoc2Id, name: "Classic Leather Wallet", description: "Genuine leather bifold wallet with RFID protection. Holds 8 cards.", price: 29.99, stock: 100, category: "Accessories", tags: ["wallet", "leather"], images: ["https://res.cloudinary.com/demo/image/upload/v1/samples/ecommerce/wallet.jpg"], isActive: true, isFeatured: false, rating: 4.5, reviewCount: 28 },
    { sellerId: sellerDoc2Id, name: "Sunglasses UV400 Polarized", description: "Stylish polarized sunglasses with UV400 protection.", price: 24.99, compareAtPrice: 44.99, stock: 70, category: "Accessories", tags: ["sunglasses", "polarized"], images: ["https://res.cloudinary.com/demo/image/upload/v1/samples/ecommerce/sunglasses.jpg"], isActive: true, isFeatured: false, rating: 4.2, reviewCount: 19 },
    { sellerId: sellerDoc2Id, name: "Canvas Backpack", description: "Durable canvas backpack with laptop compartment and padded straps.", price: 44.99, stock: 50, category: "Bags", tags: ["backpack", "canvas"], images: ["https://res.cloudinary.com/demo/image/upload/v1/samples/ecommerce/backpack.jpg"], isActive: true, isFeatured: true, rating: 4.6, reviewCount: 22 },
    { sellerId: sellerDoc2Id, name: "Running Shoes - Air Mesh", description: "Ultra-lightweight running shoes with breathable air mesh upper.", price: 64.99, compareAtPrice: 89.99, stock: 0, category: "Shoes", tags: ["shoes", "running"], images: ["https://res.cloudinary.com/demo/image/upload/v1/samples/ecommerce/shoes.jpg"], isActive: true, isFeatured: false, rating: 4.0, reviewCount: 11 },
  ];
